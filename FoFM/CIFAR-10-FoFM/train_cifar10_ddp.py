...
from utils_cifar import ema, generate_samples, infiniteloop, sample_fractional_flow, setup
            ...
            with trange(steps_per_epoch, dynamic_ncols=True) as step_pbar:
                for step in step_pbar:
                    ...
                    if FLAGS.alpha == 1.0:
                        ...
                        t, xt, ut = sample_fractional_flow(x0, x1, FLAGS.alpha, FLAGS.N_steps, rank)
                    vt = net_model(t, xt)
                    ...
                    if FLAGS.save_step > 0 and global_step % FLAGS.save_step == 0:
                        ...
                        generate_samples(
                            ema_model, FLAGS.parallel, savedir, global_step, net_="ema", alpha=FLAGS.alpha, N=FLAGS.N_steps
                        )
                        torch.save(
                            {
